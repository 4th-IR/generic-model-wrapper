...
from transformers import BlipProcessor, BlipForConditionalGeneration, GitVisionModel,  Blip2Processor, Blip2ForConditionalGeneration, AutoModelForTokenClassification
...
class ModelWrapper:
    ...
    def save_to_azure(self):
        ...
        try:
            ...
            self.upload_directory_to_azure(local_dir=self.model_save_path,
            ...
            if self.azure_config:
                ...
                if self.load_from_azure():
                    ...
                    if self.model_provider == "huggingface":
                        ...
                        # for seth
                        self.model = AutoModelForTokenClassification.from_pretrained(self.model_name, torch_dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    model_wrapper = ModelWrapper(provider='huggingface', model_name="Jean-Baptiste/roberta-large-ner-english", model_category="text", pipeline_type="token_classification")
